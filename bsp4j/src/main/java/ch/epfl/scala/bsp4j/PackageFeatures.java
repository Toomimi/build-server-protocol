...
public class PackageFeatures {
  ...
  @NonNull
  private List<Map<String, List<String>>> availableFeatures;

  @NonNull
  private List<String> enabledFeatures;

  public PackageFeatures(@NonNull final String packageId, @NonNull final List<BuildTargetIdentifier> targets, @NonNull final List<Map<String, List<String>>> availableFeatures, @NonNull final List<String> enabledFeatures) {
  ...
  @Pure
  @NonNull
  public List<Map<String, List<String>>> getAvailableFeatures() {
    return this.availableFeatures;
  }

  public void setAvailableFeatures(@NonNull final List<Map<String, List<String>>> availableFeatures) {
